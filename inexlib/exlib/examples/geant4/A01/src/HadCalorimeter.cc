...
A01::HadCalorimeter::HadCalorimeter(G4String name):G4VSensitiveDetector(name) {
  G4String HCname;
  collectionName.insert(HCname="HadCalorimeterColl");
  HCID = -1;
}

A01::HadCalorimeter::~HadCalorimeter(){;}

void A01::HadCalorimeter::Initialize(G4HCofThisEvent*HCE)
{
  hitsCollection = new A01::HadCalorimeterHitsCollection
  ...
  {
    A01::HadCalorimeterHit* aHit = new A01::HadCalorimeterHit();
    hitsCollection->insert( aHit );
  }
}

G4bool A01::HadCalorimeter::ProcessHits(G4Step*aStep,G4TouchableHistory* /*ROhist*/)
{
  ...
  A01::HadCalorimeterHit* aHit = (*hitsCollection)[hitID];
...
void A01::HadCalorimeter::EndOfEvent(G4HCofThisEvent* /*HCE*/) {}
